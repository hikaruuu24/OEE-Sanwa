...
<div class="row mt-4 mb-4">
    <div class="col-sm-8">
        <div class="card card-primary">
            ...
            <form method="POST" action="{{ route('master-data.departements.update', $departement->id) }}" novalidate>
                @method('patch')
                @csrf
                ...
                <div class="card-footer bg-gray1" style="border-radius:0px 0px 10px 10px;">
                    ...
                    <a href="{{ route('master-data.departements.index') }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
